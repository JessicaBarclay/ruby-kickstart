...
class HTMLTag
  FONTS = {
    :serif      => '"Times New Roman", "Georgia"', # font constants
    :sans_serif => '"Arial", "Verdana"',
    :monospace  => '"Courier New", "Lucida Console"' ,
  }

  COLORS = {
    :red   => '#FF0000', # font constants
    :green => '#00FF00',
    :blue  => '#0000FF',
  }
  ...
  def initialize(name, innerHTML, options=Hash.new)
    ...
    @multiline = options.fetch :multiline, false # options: :multiline should be true or false
  end

  def style
    return nil unless font || color # return nil unless font or color true. Boolean
    to_return = "style='"
